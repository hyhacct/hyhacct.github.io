---
title: Wails - 自动绑定TS失效?
categories: Wails
date: 2025-04-24 13:25:37
updated: 2025-04-24 13:25:37
tags:
  - Wails
---
...
发现一个奇怪的问题，我执行`wails dev`时突然发现我在`app.go`中暴露给前端的函数居然没能自动绑定到前端的`wailsjs/go/apps/xxx`下。
